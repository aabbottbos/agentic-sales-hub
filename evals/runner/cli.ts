#!/usr/bin/env tsx
/**
 * `pnpm eval --suite <sow-review|find-evidence|call-summary|call-prep|all>`
 *
 * Flags:
...
async function main(): Promise<void> {
  ...
  if (!suiteArg) {
    console.error("usage: pnpm eval --suite <sow-review|find-evidence|call-summary|call-prep|all>");
    process.exit(2);
  }
